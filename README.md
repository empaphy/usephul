...
### Variable handling Functions
  ...
  - [is_closed_resource()](https://usephul.empaphy.org/packages/Types-Variables.html#function_is_closed_resource)
    — Determine if a given value is a [resource](https://www.php.net/types.resource) that has been closed.
  - [is_enum_case()](https://usephul.empaphy.org/packages/Types-Variables.html#function_is_enum_case)
  ...
  - [is_zero()](https://usephul.empaphy.org/packages/Types-Variables.html#function_is_zero)
    — Determine if a given number is (sufficiently close to) 0.
