...
use empaphy\usephul\Filesystem;

describe('Filesystem\\dirname()', function () {
    test('returns correct directory name', function ($path, $returns) {
        ...
        expect($expected)->toEqual($returns);
        expect($pathinfo)->toEqual($expected);
    ...
    test('returns correct directory name, with levels', function ($path, $levels, $returns) {
        ...
        $dirname = Filesystem\dirname($path, $levels);
...
describe('Filesystem\\extension()', function () {
...
describe('Filesystem\\extension_replace()', function () {
    test('replaces directory name', function ($path, $replacement, $suffix, $returns) {
        $replaced = Filesystem\extension_replace($path, $replacement, $suffix);
...
describe('Filesystem\\filename()', function () {
    ...
    test('returns file name, without suffix', function ($path, $suffix, $expected) {
        $filename = Filesystem\filename($path, $suffix);
