...
interface Filterable extends \Traversable
{
     ...
     *   {@see Filtering::all() all()} and **callback** will not be
     ...
     *   {@see Filtering::any() any()} and the callback will not be
     *   called for further elements.
     *
     * @return bool
     ...
     *   {@see Filtering::find() find()} and the **callback** will
     ...
     *   {@see Filtering::findKey() findKey()} and the callback will
     *   not be called for further elements.
     *
     * @return TKey|null
