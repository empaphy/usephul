...
use ArrayIterator;
use ArrayObject;
use empaphy\usephul\iterable\ArrayObject\Collecting;
use empaphy\usephul\iterable\ArrayObject\Filling;
use empaphy\usephul\iterable\ArrayObject\Filtering;
use empaphy\usephul\iterable\ArrayObject\Stacking;
use Traversable;
 ...
 * @template TValue
 *
 * @use Filling<TKey, TValue>
 * @use Filtering<TKey, TValue>
 * @implements Filterable<TKey, TValue>
 * @implements Sequence<TValue>
 * @extends ArrayObject<TKey, TValue>
 */
class ArrayMap extends ArrayObject implements Filterable, Sequence
{
    use Collecting;
    use Filling;
    use Filtering;
